...
<template>
  <div class="footer">
    <div class="wrap">
      <div class="left">
        <img src="~assets/img/logo.png" alt="WATABE WEDDING华德培全球婚礼策划公司" />
      ...
      <div class="center1">
        <div class="column">
          ...
          <div class="list">
            <a href="https://huadepei.tmall.com/" target="_blank" class="item" rel="nofollow">
              <div class="img">
        ...
        <div class="column ml60">
          ...
          <div class="list">
            <a href="/privacy"  class="item" rel="nofollow">
              <div>个人信息保护方针</div>
            </a>
            <a href="/rule"  class="item" rel="nofollow">
    ...
    <div style="color:red; font-size: 12px;text-align:center;margin-top: 30px;">提供： 三亚婚礼、旅行结婚、教堂婚礼、海岛婚礼、</div>
    <div class="file">
      <div>
